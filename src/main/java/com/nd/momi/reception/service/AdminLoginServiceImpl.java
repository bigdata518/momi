...
@ServiceConfig(
        ...
        requestConfigs = {
    @RequestConfig(name = "receptionId", typeEnum = TypeEnum.CHAR_32, desc = "用户id"),
...
public class AdminLoginServiceImpl implements Service {
    ...
    public void execute(MessageContext messageContext) {
        ...
        if (receptionId.equals(ReceptionLocalService.adminUserId)) {
            ReceptionEntity adminUserEntity = this.receptionLocalService.inquireRecepitonById(receptionId);
