 ...
 *
 */
public class GameListJUnitTest extends AbstractMomiTest {

    public GameListJUnitTest() {
    }
    ...
    public void test() {
        ...
        Response response = this.testHandler.execute(ActionNames.GAME_LIST, parameterMap);
